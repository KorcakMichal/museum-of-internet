...
export function getDomRefs(root = document) {
  const refs = {
    ...
    roomIndoorBackdrop: root.getElementById('roomIndoorBackdrop'),
    ...
    grandmaChat: root.getElementById('grandmaChat'),
    grandmaChatCloseButton: root.getElementById('grandmaChatCloseButton'),
    grandmaChatMessages: root.getElementById('grandmaChatMessages'),
    grandmaChatForm: root.getElementById('grandmaChatForm'),
    grandmaChatInput: root.getElementById('grandmaChatInput'),
